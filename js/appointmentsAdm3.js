            ...
            if (status ==="success") {
                ...
                data.forEach(appointment => {
                    ...
                    : appointment.expired ? `
                            ...
                            ` : `
                                <button class="action-appointment confirm" data-status="confirmed" data-id="${appointment.appointmentId}">Confirmar</button>
                                <button class="action-appointment decline" data-status="declined" data-id="${appointment.appointmentId}">Recusar</button>
                            `;
                    ;
                    appointmentHTML += `
                        <li>
                            <div class="appointment-container">
                                <div class="appointment-content-container">
                                    ...
                                    <p class="author">${appointment.clientName}</p>
                                </div>
